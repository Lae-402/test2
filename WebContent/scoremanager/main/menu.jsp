...
<c:param name="title">得点管理システム</c:param>
	...
	<div style="margin: 0; padding: 15px 0 0 0; font-size: 170%; box-sizing: border-box; text-align: center;">
				<p style="margin-bottom: -40px;">
					<a href="StudentList.action" style="font-size: 100%;">学生管理</a></p><br>
					<p><a href="TeacherList.action" style="font-size: 100%;">教師一覧</a></p>
						</div>
			</div>
			...
			<div class="col d-flex align-items-center justify-content-center mx-2 rounded shadow"
				...
				<div style="margin: 0; padding: 15px 0 0 0; font-size: 170%; box-sizing: border-box; text-align: center;">
					...
					<p style="margin-bottom: -40px;">
					<a href="TestRegist.action" style="font-size: 100%;">成績登録</a></p><br>
